...
CURRENT_DIR=$(pwd)
LOG_PATH="${CURRENT_DIR}/companions/logs"
PATCHES_PATH="${CURRENT_DIR}/companions/patches"
FLAT_FILES_PATH="${CURRENT_DIR}/companions/flat-files"
KB_PATH="${CURRENT_DIR}/companions/kb"
SKETCH_PATH="${CURRENT_DIR}/companions/sketches"
KIOSK_QUESTIONS_PATH="${CURRENT_DIR}/companions/kiosk-questions"
PYTHONIAN_CODE="${CURRENT_DIR}/companions/pythonian"
